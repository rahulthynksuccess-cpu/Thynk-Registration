...
export async function PATCH(req: NextRequest) {
  ...
  if (email_trigger_enabled    !== undefined) updates.email_trigger_enabled    = email_trigger_enabled;
  if (whatsapp_trigger_enabled !== undefined) updates.whatsapp_trigger_enabled = whatsapp_trigger_enabled;
