  ...
  return (
    <div style={{minHeight:'100vh',background:'var(--bg)',fontFamily:'DM Sans,sans-serif'}}>
      ...
      <div style={{maxWidth:900,margin:'0 auto',padding:'32px 24px'}}>
        <div style={{marginBottom:28}}><h1 style={{fontFamily:'Sora,sans-serif',fontSize:26,fontWeight:800,color:'var(--text)',margin:'0 0 4px'}}>Integrations <span style={{color:'var(--acc)'}}>Setup</span></h1><p style={{fontSize:13,color:'var(--m)',margin:0}}>Payment gateways, email & WhatsApp — configure all external services</p><a href="/admin/integrations/thynkflow" style={{display:'inline-block',marginTop:8,fontFamily:'DM Sans,sans-serif',fontSize:12,color:'var(--acc)',fontWeight:700,textDecoration:'none'}}>🔗 ThynkFlow CRM integration key →</a></div>
