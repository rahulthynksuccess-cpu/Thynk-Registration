...
export default function FollowupsDashboardPage({
  ...
  }, [combined, typeFilter, dueFilter, search]);
    ...
    <>
      ...
      <div className="tbl-wrap">
        <table>
          <thead>
            <tr>
              <th>Type</th><th>Name</th><th>Next Follow-up</th><th>Last Comment</th><th>Logged By</th><th>Action</th>
            </tr>
          </thead>
          <tbody>
            {filtered.length === 0 && (
              <tr><td colSpan={6} className="table-empty">Nothing matches these filters.</td></tr>
            )}
            {filtered.map(r => {
